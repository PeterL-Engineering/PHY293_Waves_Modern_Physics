...
\section{Uncertainty Derivation for Internal Resistance}

\subsection*{Step 1: Uncertainty in Numerator $N = R_{V} \cdot m_{1}$}
\begin{align*}
N = R_{V} \cdot m_{1} \quad \Rightarrow \quad \left(\frac{\sigma_N}{N}\right)^2 = \left(\frac{\sigma_{m_{1}}}{m_{1}}\right)^2 + \left(\frac{\sigma_{R_{V}}}{R_{V}}\right)^2 \quad \Rightarrow \quad \sigma_N = N \cdot \sqrt{\left(\frac{\sigma_{m_{1}}}{m_{1}}\right)^2 + \left(\frac{\sigma_{R_{V}}}{R_{V}}\right)^2}
\end{align*}

\subsection*{Step 2: Uncertainty in Denominator $D = R_{V} - m_{1}$}
\begin{align*}
D = R_{V} - m_{1} \quad \Rightarrow \quad \sigma_D = \sqrt{\sigma_{R_{V}}^2 + \sigma_{m_{1}}^2}
\end{align*}  

\subsection*{Step 3: Uncertainty in Quotient $R_{internal} = \frac{N}{D}$}
\begin{align*}
R_{internal} = \frac{N}{D} \quad \Rightarrow \quad \left(\frac{\sigma_{R_internal}}{R_{internal}}\right)^2 = \left(\frac{\sigma_N}{N}\right)^2 + \left(\frac{\sigma_D}{D}\right)^2 \quad \Rightarrow \quad \sigma_{R_{internal}} = R_{internal}\cdot \sqrt{\left(\frac{\sigma_N}{N}\right)^2 + \left(\frac{\sigma_D}{D}\right)^2}
\end{align*}

\subsection*{Final Combined Expression}
\begin{align*}
\sigma_{R_{internal}} = \frac{m_{1} \cdot R_{V}}{{R_{V}} - m_{1}} \cdot \sqrt{\left(\frac{\sigma_{m_{1}}}{m_{1}}\right)^2 + \left(\frac{\sigma_{R_{V}}}{R_{V}}\right)^2 + \left(\frac{\sigma_{I \cdot R_{li}}}{I \cdot R_{li}}\right)^2 + \left(\frac{\sigma_V}{I \cdot R_{li} - V}\right)^2}
\end{align*}
